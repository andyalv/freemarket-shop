...
import { MdAdd, MdCalendarMonth, MdLocalShipping, MdLocationOn, MdPerson, MdRemove } from "react-icons/md";
...
export function ProductDetailPanel({
  ...
  return (
    ...
    >
      ...
      <section className="absolute inset-x-4 top-1/2 mx-auto w-full max-w-5xl -translate-y-1/2">
        <div className="mb-3 flex items-center justify-between">
          <h3 className="text-2xl font-bold">Sample product detail</h3>
          <button
            type="button"
            onClick={onClose}
            className="fm-btn fm-btn-secondary px-4 py-2 text-sm"
          >
            Back to products
          </button>
        </div>
        ...
        <div className="overflow-hidden rounded-[14px] border border-[var(--fm-border)] bg-[var(--fm-surface)] shadow-[0_6px_20px_rgba(0,0,0,0.1)] lg:grid lg:grid-cols-[1.2fr_0.8fr]">
          <div className="aspect-[4/3] bg-[var(--fm-color-cream)] lg:aspect-auto lg:min-h-[420px]" />
            ...
            <div className="mt-5 border-t border-[var(--fm-border)] pt-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="grid grid-cols-[24px_1fr] gap-2 rounded-xl border border-[var(--fm-border)] bg-[#faf7f2] p-3">
                  ...
                  <p className="text-sm">
                    <strong>Batch/Harvest:</strong> {product.batchHarvest}
                  </p>
                </div>
                <div className="grid grid-cols-[24px_1fr] gap-2 rounded-xl border border-[var(--fm-border)] bg-[#faf7f2] p-3">
